            ...
            <div class="row">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="mydata">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td> <?php echo $no++ ?> </td>
                                    <td class="center"> <?php echo $r['role']; ?> </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li>
                                                    <a class="" data-toggle="modal" href="<?= base_url('c_admin/roleAccess/') . $r['id']; ?>">
                                                        <i class="icon-share-alt"></i> Access </a>
                                                </li>
                                                <li>
                ...
                <div class="modal fade" id="basic" tabindex="-1" role="basic" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="<?php echo base_url('c_admin/role'); ?> " method="POST">
