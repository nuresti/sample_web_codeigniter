...
<div class="page-title">
    <h1>Sub Menu Management
        <small>Sub Menu Management</small>
    </h1>
</div>
</div>
</div>
    ...
    <div class="page-content-inner">
        <div class="mt-content-body">
            <div class="row">
                ...
                '</div>'); ?>
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a class="" data-toggle="modal" href="#newsubmenu">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column mydata" id="mydata">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td> <?php echo $no++ ?> </td>
                                    <td class="center"> <?php echo $sm['title']; ?> </td>
                                    <td class="center"> <?php echo $sm['menu']; ?> </td>
                                    <td class="center"> <?php echo $sm['url']; ?> </td>
                                    <td class="center"> <?php echo $sm['icon']; ?> </td>
                                    <td class="center"> <?php echo $sm['is_active']; ?> </td>
                                    <td>
                                        <div class="btn-group">
                ...
                <!-- ADD -->
                <div class="modal fade" id="newsubmenu" tabindex="-1" role="basic" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="<?php echo base_url('c_menu/submenu'); ?> " method="POST">
                                    ...
                                    <form role="form">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Sub Menu Title" id="title" name="title"> 
                                            </div>
                                            <div class="form-group">
